...
class Box extends React.Component {
    ...
    downloadFile = () => {
        Axios.get(`/api/download?fileHash=${this.fileHash}`, { responseType: 'blob' })
        .then((response) => {
    ...
    render() {
        const extra = (
            <Segment.Group horizontal>
                <Segment className="FileLink"><Icon name="cloud download" /><a onClick={this.downloadFile}>{this.name}.csv</a></Segment>
